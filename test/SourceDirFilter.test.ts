...
describe('test SourceDirFilter', function () {
    describe('test isIgnored(relativePath)', function () {
        it('should ignore .git directory', function () {
            expect(defaultFilter.isIgnored('something/.git/something-else.md')).toBe(true);
        });
        ...
        it('should ignore node_modules sub directory', function () {
            expect(defaultFilter.isIgnored('something/node_modules/something-else.md')).toBe(true);
        });

        it('should not ignore node_modules_example directory', function () {
            expect(defaultFilter.isIgnored('node_modules_example/something-else.md')).toBe(false);
        });
